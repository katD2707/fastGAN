...
class DistModel(BaseModel):
    ...
    def clamp_weights(self):
        for module in self.net.modules():
            if (hasattr(module, 'weights') and module.kernel_size == (1, 1)):
    ...
    def forward_train(self):  # run forward pass
        ...
        # print(torch.norm(self.net.module.net.slice1[0].weights).item(), torch.norm(self.net.module.lin0.model[1].weights).item())
